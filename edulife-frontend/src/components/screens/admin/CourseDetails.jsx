...
const CourseDetails = ({ selectedCourse, handleEditCourse, setSelectedCourse, courses }) => {
  ...
  const handleDeleteCourse = () => {
    if (window.confirm(t('courseDetails.deleteConfirm', { title: selectedCourse.title }))) {
