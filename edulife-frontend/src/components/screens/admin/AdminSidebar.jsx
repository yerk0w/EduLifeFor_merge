    ...
    <div className="admin-sidebar">
      <div className="sidebar-tabs">
        ...
        >
          ...
          <span className="tab-text">{t('adminPanel.dashboard')}</span>
        </button>
        ...
        >
          ...
          <span className="tab-text">{t('adminPanel.schedule')}</span>
        </button>
        ...
        >
          ...
          <span className="tab-text">{t('adminPanel.students')}</span>
        </button>
        ...
        >
          ...
          <span className="tab-text">{t('adminPanel.attendance')}</span>
        </button>
        ...
        >
          ...
          <span className="tab-text">{t('adminPanel.documents')}</span>
        </button>
      </div>
      ...
      <button className="logout-button" onClick={handleBack}>
        ...
        <span className="button-text">{t('adminPanel.logout')}</span>
      </button>
    </div>
  );
};
